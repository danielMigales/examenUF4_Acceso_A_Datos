...
public class Comentario implements Serializable { //BEAN FUENTE{
    ...
    private String comentario;//propiedad compartida que si cambia lanza un evento
    ...
    public void setComentario(String comentarioNuevo) {
        ...
        if (this.comentario.equals("cabron")|| (this.comentario.equals("mierda")) || (this.comentario.equals("gilipollas"))){
